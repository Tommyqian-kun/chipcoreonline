# ChipCore
 **Open-source evolution of a chip back-end EDA toolchain used in 7nm/5nm mobile SoC mass production. Platform released first; tool kernels and pre-built Docker images to be published in subsequent releases.**
